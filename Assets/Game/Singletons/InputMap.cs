...
public enum Action
{
    UP, DOWN, LEFT, RIGHT, PRIM, HEAVY, INTRIN, LAST_WORD, SLOW, CAST_CIRCLE
}
...
public class InputMap : Singleton<InputMap>
{
    ...
    void Awake()
    {
        ...
        actionMaps[0].Add(Action.CAST_CIRCLE, KeyCode.LeftControl);
        ...
        actionMaps[1].Add(Action.CAST_CIRCLE, KeyCode.RightControl);
    }
